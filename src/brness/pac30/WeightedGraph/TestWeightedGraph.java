...
public class TestWeightedGraph {
    public static void main(String[] args) {
        ...
        int[][] edges={{0, 1,807}, {0, 3, 1131}, {0, 5,2097},
        ...
        System.out.println("The number of the vertices is "+graph.getSize());
        System.out.println("The vertex with index 1 is "+graph.getVerTex(1));
        System.out.println("The index for Miami is "+graph.getIndex("Miami"));
        System.out.println("The edges for graph:");
        graph.printWeightedEdges();

        edges=new int[][]{{0,1,2},{0,3,8},{1,0,2},{1,2,7},{1,3,3},{2,1,7},{2,3,4},{2,4,5},{3,0,8},
